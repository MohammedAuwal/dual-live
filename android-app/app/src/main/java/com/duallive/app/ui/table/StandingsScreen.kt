...
fun StandingsScreen(teams: List<Team>, standings: List<Standing>) {
    ...
    Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
        ...
        Text("Format: Round Robin ($totalMatchesPerTeam games per team)", style = MaterialTheme.typography.bodySmall)
        
        Spacer(modifier = Modifier.height(16.dp))
        
        // Use a horizontal scroll in case the screen is narrow (20 teams often means long names)
        ...
        Column(modifier = Modifier.horizontalScroll(scrollState)) {
            ...
            LazyColumn {
                items(standings) { standing ->
                    ...
                    Divider(thickness = 0.5.dp, alpha = 0.3f)
                }
            }
        }
    }
